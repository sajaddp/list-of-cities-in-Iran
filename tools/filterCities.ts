...
async function processJSON() {
  ...
  console.log(
    `JSON: ${originalCount} cities → ${filteredCount} cities (removed ${originalCount - filteredCount})`,
  );
...
async function processCSV() {
  ...
  console.log(
    `CSV: ${originalCount} cities → ${filteredCount} cities (removed ${originalCount - filteredCount})`,
  );
  console.log(`Output: ${outputPath}`);
}
...
async function processXLSX() {
  ...
  console.log(
    `XLSX: ${originalCount} cities → ${filteredCount} cities (removed ${originalCount - filteredCount})`,
  );
  console.log(`Output: ${outputPath}`);
}
